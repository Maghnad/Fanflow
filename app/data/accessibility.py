...
ACCESSIBILITY: dict[str, AccessibilityData] = {
    "metlife": {
        "accessible_routes": [
            {
                "from_location": "A",
                "to_location": "concourse_north",
                "distance_meters": 70,
                "features": ["ramp", "wide_path"],
            },
            {
                "from_location": "concourse_north",
                "to_location": "elevator_north",
                "distance_meters": 40,
                "features": ["elevator"],
            },
            {
                "from_location": "elevator_north",
                "to_location": "concourse_east",
                "distance_meters": 160,
                "features": ["wide_path", "tactile_paving"],
            },
            {
                "from_location": "B",
                "to_location": "concourse_east",
            ...
            {
                "from_location": "concourse_east",
                "to_location": "elevator_east",
                "distance_meters": 35,
                "features": ["elevator"],
            },
            {
                "from_location": "C",
                "to_location": "concourse_south",
                "distance_meters": 70,
                "features": ["ramp", "wide_path"],
            },
            {
                "from_location": "concourse_south",
                "to_location": "elevator_south",
                "distance_meters": 40,
                "features": ["elevator"],
            },
            {
                "from_location": "D",
                "to_location": "concourse_west",
                "distance_meters": 70,
                "features": ["ramp", "wide_path"],
            },
            {
                "from_location": "concourse_west",
                "to_location": "elevator_west",
                "distance_meters": 45,
                "features": ["elevator"],
            },
        ],
        "quiet_zones": [
            {
                "name": "Quiet Room North",
                "location": "concourse_north",
                "nearest_gate": "A",
                "capacity": 20,
            },
            {
                "name": "Sensory Room East",
                "location": "concourse_east",
                "nearest_gate": "B",
                "capacity": 15,
            },
        ],
        "sign_language_staff": [
            {
                "location": "Gate A Information Desk",
                "languages": ["ASL"],
                "hours": "2h before kickoff — 1h after match",
            },
            {
                "location": "Guest Services (Section 100)",
                "languages": ["ASL", "ISL"],
                "hours": "All match hours",
            },
        ],
        "wheelchair_sections": ["Section 100", "Section 200", "Section 300", "Section 400"],
        "service_animal_relief": [
            "Relief Area near Gate D (outdoor)",
            "Relief Area near Gate A (outdoor)",
        ],
        "accessible_graph": {
    ...
    "sofi": {
        ...
        "quiet_zones": [
            {
                "name": "Sensory Suite West",
                "location": "concourse_west",
                "nearest_gate": "D",
                "capacity": 25,
            },
        ],
        "sign_language_staff": [
            {
                "location": "Guest Services (Gate A)",
                "languages": ["ASL"],
                "hours": "All match hours",
            },
        ],
    ...
    "att": {
        ...
        "quiet_zones": [
            {
                "name": "Quiet Room South",
                "location": "concourse_south",
                "nearest_gate": "C",
                "capacity": 18,
            },
        ],
    ...
    "hardrock": {
        ...
        "sign_language_staff": [
            {
                "location": "Guest Services (Gate B)",
                "languages": ["ASL"],
                "hours": "All match hours",
            },
        ],
    ...
    "azteca": {
        ...
        "sign_language_staff": [
            {
                "location": "Servicios (Puerta A)",
                "languages": ["LSM"],
                "hours": "Horario completo del partido",
            },
        ],
